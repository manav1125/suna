            ...
            if self._is_presentation_slide_file(target_file):
                return ToolResult(success=False, output=json.dumps({
                    "message": (
                        ...
                        "Use populate_template_slide for copied template slides, or "
                        "full_file_rewrite only when you intentionally need a full "
                        "structural rewrite while preserving the existing HTML/CSS design."
                    ),
